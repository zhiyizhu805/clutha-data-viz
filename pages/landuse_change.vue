  ...
  <organisimsBaseArticleContainerPrimary>
    ...
    <template #right>
      ...
      >
        ...
        <template #graph>
          <img
            src="/assets/images/maps/map_landuse.svg"
            alt="Landuse Map"
            title="Landuse Map"
          />
        </template>
        ...
        <organisimsTableContainer>
          <thead>
            <tr>
              ...
              <th scope="col" class="py-3 px-6">Net change since 1990 (ha)</th>
            </tr>
          </thead>
  ...
  <organisimsBaseArticleContainerPrimary>
    <template #left>
      ...
      <moleculesParagraph>
        ...
        conversion of production grassland (52 ha). 52 ha account for 0.02% of
