<template>
  <div>
    <h1>Exotic Forest Land Use Change 2008-2018</h1>
    <nuxt-plotly
      :data="pieChart.data"
...
const csvData = [
  {
    ...
    startYear: 2008,
    endYear: 2018,
    productionGrassland: 51.92,
    fernland: 18.15,
    manukaAndOrKanuka: 1,
  },
];

const labels = ['Production grassland', 'Fernland', 'Manuka and/or Kanuka'];
const values = [51.92, 18.15, 1];

const colors = ['#009E73', '#FFB44F', '#CC79A7']; 
